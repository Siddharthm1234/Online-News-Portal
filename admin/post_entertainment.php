...
body {
  ...
  <a class="navbar-brand" href="<?php echo ROOT_URL?>add_entertainment.php">Add Post</a>
	...
	<div class="container">
			...
			<br>
			<a class="btn btn-primary" href="<?php echo ROOT_URL?>entertainment.php">Back to Home Site</a> <br>
			<br>
			
			<a class="btn btn-success" href="<?php echo ROOT_URL?>edit_entertainment.php?id=<?php echo $POST['id'];?>" >Edit Post</a>
