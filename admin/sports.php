<?php
	...
	$query= 'Select* from posts where cat_id="2" order by created_at desc';
	//Get the results
  ...
  <a class="navbar-brand" href="<?php echo ROOT_URL?>add_sports.php">Add Post</a>
	...
	<?php foreach($posts as $post) :?>
		<div class="well"><div class="box123">
			...
			<a class="btn btn-success" href="<?php echo ROOT_URL?>post_sports.php?id=<?php echo $post['id']; ?>">Read More </a></center>
